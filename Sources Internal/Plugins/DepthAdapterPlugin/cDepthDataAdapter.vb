...
#Region "Adapter Overrides "
    ...
    Private Function setDepthCells(ByVal bm As cEcospaceBasemap, _
        ...
        Dim iRow As Integer
        Dim iCol As Integer
        Dim dNoData As Integer = -9999
        Dim orgDepth As Double
        ...
        Try
            ...
            For iRow = 1 To bm.InRow
                For iCol = 1 To bm.InCol
                    ...
                    'Clear out the change flag
                    Me.m_bChanged(iRow, iCol) = False
                    'Get the current depth value
                    'This is for optimization it's time consuming to get a value from a layer cell
                    orgDepth = CDbl(layerDepth.Cell(iRow, iCol))

                    'Original cell was not land and the new depth is different
                    If (orgDepth > 0) And (CellValue <> orgDepth) Then
                        'Depth has changed
                        'Set the new depth
