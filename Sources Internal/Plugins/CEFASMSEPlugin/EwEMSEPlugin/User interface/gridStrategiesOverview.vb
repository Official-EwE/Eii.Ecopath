...
#Region " Overrides "
    ...
    Protected Overrides Sub InitStyle()
        ...
        Me(0, eColumnTypes.StrategyName) = New EwEColumnHeaderCell("Name")
        Me(0, eColumnTypes.RunStrategy) = New EwEColumnHeaderCell("Run Yes/No")
    ...
    Protected Overrides Function OnCellEdited(p As SourceGrid2.Position, cell As SourceGrid2.Cells.ICellVirtual) As Boolean
        ...
        ' Check column
        'If (p.Column = eColumnTypes.StrategyName) Then
        '    ' Store value
