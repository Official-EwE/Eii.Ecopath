...
#Region "Helper methods"
    Private Shared Sub SetUpGridColumn(ByVal DataGrid As DataGridView, ByVal EcotrophManager As cEcotrophManager)
        DataGrid.ColumnCount = EcotrophManager.transposeCatches.GetUpperBound(1) + 2
        ...
        DataGrid.Columns(1).HeaderText = My.Resources.COL_HDR_FLT_NAME_TRP_LVLOUT
    ...
    Private Shared Sub SetUpGridRow(ByVal DataGrid As DataGridView, ByVal EcotrophManager As cEcotrophManager)
        ...
        DataGrid.RowCount = EcotrophManager.transposeCatches.GetUpperBound(0)

        ReDim RowContent(DataGrid.Columns.Count)
        TLOut = 2
        For Row As Integer = 1 To EcotrophManager.transposeCatches.GetUpperBound(0)
            ...
            End If
            For Col As Integer = 1 To EcotrophManager.transposeCatches.GetUpperBound(1)
                RowContent(Col + 1) = (EcotrophManager.transposeCatches(Row, Col)).ToString("F4")
            Next
