...
''' </remarks>
''' 
Public Class cEcospaceSensitivityPluginPoint
...
#Region "Local variables"
    ...
    ' Private m_MonteCarlo As cEcosimMonteCarlo
    Private m_runManager As cRunManager

    Private m_uic As cUIContext = Nothing
    Private m_form As frmEcospaceSensitivity = Nothing
...
#Region "Core, Ecopath, Ecosim and Ecospace Datastructures"
    ...
    Public ReadOnly Property RunManager As cRunManager
        Get
            Return Me.m_runManager
        End Get
    End Property
    ...
    Public Sub OnControlClick(ByVal sender As Object, ByVal e As System.EventArgs, ByRef form As Windows.Forms.Form) Implements EwEPlugin.IGUIPlugin.OnControlClick
        ...
        If m_uic IsNot Nothing Then
            ...
            If Not bHasInterface Then
                ...
                Me.m_form = New frmEcospaceSensitivity()
                Me.m_form.Init(Me)
...
#Region "IPlugin implementation"
    ...
    Public ReadOnly Property Description As String Implements EwEPlugin.IPlugin.Description
        Get
            Return "Run Ecospace with the Monte Carlo "
        End Get
    End Property
