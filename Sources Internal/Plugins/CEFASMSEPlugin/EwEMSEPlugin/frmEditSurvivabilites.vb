...
Public Class frmEditSurvivabilites
    ...
    Private Sub PopulateTable(strPath As String)
        ...
        'reader = cMSEUtils.GetReader(cMSEUtils.MSEFile(DataPath, cMSEUtils.eMSEPaths.DistrParams, "Survivabilities.csv"))
    ...
    ''' <remarks></remarks>
    Private Function ExtractSurvivabilityParameter(csv) As SurvivabilityDistributonParam
        ...
        Return New SurvivabilityDistributonParam(TFleetNumber, TFleetName, TGroupNumber, TGroupName, TAlpha, TBeta)
