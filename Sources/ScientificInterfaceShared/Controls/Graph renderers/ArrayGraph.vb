...
Public Class ArrayGraph
    ...
    Public Sub Draw(ByVal g As Graphics, ByVal rcRender As Rectangle, _
                    ByVal asData As Single(,), ByVal astrLabelsX As String(), Optional ByVal astrLabelsY As String() = Nothing)
        ...
        ' Top text
        DrawLabelsTop(g, rcArea1, sCellSize, astrLabelsX, szLabelTopMaxSize, -90 + cLABEL_TOPAXIS_ANGLE)
        ' Side text
        DrawLabelsSide(g, rcArea3, sCellSize, astrLabelsY)
        ' Graph
...
#Region " Rendering "
    ...
    Private Sub DrawLabelsTop(ByVal g As Graphics, ByVal rect As Rectangle, ByVal sCellSize As Single, _
                              ByVal astrLabels As String(), ByVal szLabelMaxSize As Size, _
