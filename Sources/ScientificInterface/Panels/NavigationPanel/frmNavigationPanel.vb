...
#End If
        ...
        nodeFolder = Me.m_nodecontroller.Add(My.Resources.LABEL_NAV_SPACE_FISHERY, "ndEcospaceFishery", eCoreExecutionState.EcospaceLoaded, Nothing, eNodeImages.Input, nodeInput)
