...
Public Class gridRiskBounds
    ...
    Protected Overrides Sub InitStyle()
        ...
        Me(0, 1) = New EwEColumnHeaderCell("Min. biomass/org. biomass")
        Me(0, 2) = New EwEColumnHeaderCell("Max. biomass/org. biomass")
    ...
    Protected Overrides Sub FillData()
        Try
            ...
            For igrp As Integer = 1 To m_core.nLivingGroups
                ...
                Me(igrp, 1) = New PropertyCell(mse.GroupInputs(igrp), eVarNameFlags.MSELowerRisk)
                Me(igrp, 2) = New PropertyCell(mse.GroupInputs(igrp), eVarNameFlags.MSEUpperRisk)
