...
#Region " Private vars "
    ...
    Private m_results As cOBISTaxonSearchResults = Nothing
...
#Region " Search "
    ...
    Public Function CreateSearchTerm() As Object _
        ...
        Return New cOBISTaxonData(Assembly.GetExecutingAssembly().GetName().Name, Me.Name)
    End Function
