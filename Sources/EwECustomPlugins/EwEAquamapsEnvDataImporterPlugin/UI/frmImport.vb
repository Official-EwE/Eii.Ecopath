...
#Region " Internals "
    ...
    Private Sub OnViewExample(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) _
        ...
        Try
            ...
            msg = New cMessage(String.Format(My.Resources.STATUS_EXAMPLE_SAVE_SUCCESS, strFile),
        ...
        Catch ex As Exception
            msg = New cMessage(String.Format(My.Resources.STATUS_EXAMPLE_SAVE_FAILED, strFile),
