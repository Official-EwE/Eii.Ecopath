'==============================================================================
'
' $Log: cTransposeCatch.vb,v $
' Revision 1.1  2008/09/26 07:30:41  sherman
' --== DELETED HISTORY ==--
'
' Revision 1.15  2008/06/05 19:43:46  joeh
' no message
'
'==============================================================================
Option Explicit On
...
#Region "Public methods"
    ...
    Public Shared Sub DisplayGridData(ByVal DataGrid As DataGridView, ByVal Transpose As UserInterface.cTranspose, _
      ByVal FleetNumber As Integer, ByVal Algor As String)
        ...
        SetUpGridRow(DataGrid, Transpose.m_EcotrophManager, FleetNumber, Algor)
        Cursor.Current = Cursors.Default
    End Sub
      ...
      ByVal Algor As String)
        Select Case Algor
            ...
            Case My.Resources.TREE_NODE_OMNI_IDX, My.Resources.TREE_NODE_USER_DEF_SIGMA
                DataGrid.RowCount = EcotrophManager.TransposeCatch.GetUpperBound(0) + 1
        End Select
    ...
    ByVal FleetNumber As Integer, ByVal Algor As String)
        ...
        Select Case Algor
            Case My.Resources.TREE_NODE_AUTO_SMOOTH ', My.Resources.TREE_NODE_OMIN_IDX
                SetUpAryRow(DataGrid, EcotrophManager, FleetNumber, Algor)
            Case My.Resources.TREE_NODE_OMNI_IDX
                'Set up Sigma row
                RowContent(0) = ""
    ...
    Private Shared Sub SetUpAryRow(ByVal DataGrid As DataGridView, ByVal EcotrophManager As cEcotrophManager, _
      ByVal FleetNumber As Integer, ByVal Algor As String)
        ...
        For Row As Integer = 1 To EcotrophManager.TransposeCatch.GetUpperBound(0)
            ...
            End If
            For Col As Integer = 1 To EcotrophManager.TransposeCatch.GetUpperBound(1)
                If Single.IsNaN(EcotrophManager.TransposeCatch(Row, Col, FleetNumber)) Then
                    RowContent(Col + 1) = ""
                Else
