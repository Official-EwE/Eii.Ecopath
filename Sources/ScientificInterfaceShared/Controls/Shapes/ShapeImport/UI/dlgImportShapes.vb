...
#Region " Internals "
        ...
        Private Sub Read()
            ...
            If Not File.Exists(strFile) Then
                Dim msg As New cMessage(cStringUtils.Localize(My.Resources.FILE_LOAD_ERROR_MISSING, strFile),
            ...
            Else
                Try
                    ...
                    End Using
                Catch ex As Exception
                    Dim msg As New cMessage(cStringUtils.Localize(My.Resources.FILE_LOAD_ERROR_DETAIL, strFile, ex.Message),
                                            eMessageType.DataImport, eCoreComponentType.External, eMessageImportance.Critical)
                    Me.m_uic.Core.Messages.SendMessage(msg)
                End Try
            End If
