...
Public Class cEcosimDatastructures
    ...
    Public Sub RedimOutputsByTime(ByVal nTimesteps As Integer)
        ...
        ReDim relQt(nGear, nGroups, nTimesteps)
        For i As Integer = 0 To nGear : For j As Integer = 0 To nGroups : For t As Integer = 0 To nTimesteps : relQt(i, j, t) = cCore.NULL_VALUE : Next t : Next j : Next i
