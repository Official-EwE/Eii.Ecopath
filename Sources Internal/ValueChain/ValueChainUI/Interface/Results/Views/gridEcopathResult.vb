...
Public Class gridEcopathResult
    ...
    ''' </summary>
    ''' -----------------------------------------------------------------------
    Public Sub ShowResults(iFleet As Integer,
                           lUnits As cUnit(),
                           results As cResults,
                           iYear As Integer) _
    ...
    Private Sub UpdateDataCell(cell As Cells.ICell, results As cResults, vn As cResults.eVariableType, lUnits As cUnit(), iFleet As Integer, iYear As Integer)
