...
Namespace Ecospace
    ...
    ''' =======================================================================
    ''' <summary>
    ''' Form implementing the Ecospace fisheries interface.
    ''' </summary>
    ''' =======================================================================
    Public Class frmEcospaceFishery
        ...
        Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
            ...
            cmd = Me.CommandHandler.GetCommand("EditHabitats")
        ...
        Protected Overrides Sub OnFormClosed(ByVal e As System.Windows.Forms.FormClosedEventArgs)
            ...
            cmd = Me.CommandHandler.GetCommand("EditHabitats")
            If (cmd IsNot Nothing) Then cmd.RemoveControl(Me.m_tsbnDefineHabitats)
