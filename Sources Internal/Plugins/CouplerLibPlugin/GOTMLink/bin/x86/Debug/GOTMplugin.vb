                ...
                For m = 0 To noip - 1
                    ...
                    For xdim = 1 To xmax
                        For ydim = 1 To ymax
                            ...
                            ds.Bcell(ydim, xdim, (cp.OrgReference(imodellm(n), ifinputs(n), m) + 1)) = modd(m)(ycell)  REM biomass at timestep is 1 indexed
                        Next
                    Next
                Next
            Next
            If isrescale Then
                If isrescale2 Then
                    ...
                    For xdim = 1 To xmax
                        For ydim = 1 To ymax
                            ycell = (ymax - ydim) * xmax + (xdim - 1)
                            'ds.HabType(ydim, xdim) = habitat2(ycell)
                        Next
                    Next
