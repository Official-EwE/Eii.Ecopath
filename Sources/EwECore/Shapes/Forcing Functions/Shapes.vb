...
' --== DELETED HISTORY ==--
'
' Revision 1.10  2008/07/01 19:13:12  sherman
' Merged branch - Fix_Ecopat_EcosimUpdateBug
'
' Revision 1.9.2.2  2008/07/01 18:36:29  sherman
' Merged Fix_Ecopat_EcosimUpdate...
'
' Revision 1.9  2008/06/06 15:56:07  joeb
' Moved eDataTypes to EwEUtils.Core
'
' Revision 1.8  2008/01/26 00:20:18  joeb
' ResetToDefaults and LockUpdates (ResetToDefaults() still not working right)
'
' Revision 1.7  2007/11/26 14:49:14  jeroens
' * Fixed bug 351
'
' Revision 1.6  2007/11/21 22:28:23  jeroens
' * Fixed enum eShapeFunctionType
'
' Revision 1.5  2007/10/31 16:00:15  jeroens
' - FishRate shapes no longer try to determine ecosim index; this must be provided by manager
'
' Revision 1.4  2007/09/28 18:53:44  joeb
' changing the number of years
'
' Revision 1.3  2007/07/17 02:15:39  jeroens
' * cTimeSeries now inherited from cShapeData
'
' Revision 1.2  2007/07/12 18:07:41  joeb
' Fixed iEcosimIdex bug
'
' Revision 1.1  2007/07/12 15:50:23  jeroens
' * Moved
'
' Revision 1.13  2007/07/02 17:53:20  joeb
' Egg production manager changes
'
' Revision 1.12  2007/06/28 19:10:07  joeb
' EggProduction manager changes
'
' Revision 1.11  2007/05/30 15:17:44  joeb
' Added isSeasonal boolean flag
'
' Revision 1.10  2007/05/28 15:47:06  joeb
' Changes to Mediation Shapes in how they handle mediating groups and fleets
'
' Revision 1.9  2007/05/25 15:33:56  jeroens
' * Renamed Count methods
'
' Revision 1.8  2007/05/25 15:30:11  jeroens
' * Fixed fleet updates, clearing
'
' Revision 1.7  2007/05/25 01:26:41  jeroens
' + Added cMediationFleet, semi-list interfaces on cMediationFunction fleets
'
' Revision 1.6  2007/05/24 19:23:13  joeb
' Added Clear method
'
' Revision 1.5  2007/05/23 17:19:20  joeb
' Bug fixes in Mediation shapes
'
' Revision 1.4  2007/05/04 04:16:02  jeroens
' * Fixed load failure bug
'
' Revision 1.3  2007/01/24 16:33:20  joeb
' Completed removal of cPredPreyMatrix
'
' Revision 1.2  2007/01/17 20:10:37  joeb
' Edits to comments
'
' Revision 1.1  2007/01/11 16:04:53  joeb
' Added PPImanager
' Added PredPreyInteraction
' Changed the name of cForcingFunctionManager to ShapeManager
' Changed to name of cForcingFunctions to Shapes
'
' Revision 1.41  2006/11/03 17:32:58  joeb
' Added support for the "All Fleets" shape type to the FishRate shapes and Manager
'
' Revision 1.40  2006/10/24 17:18:15  joeb
' Disable dynamic update for FishRateShapes
'
' Revision 1.39  2006/10/19 23:13:35  joeb
' Changed FishingRate and FishMort shape to live update for testing
'
' Revision 1.38  2006/10/18 17:08:03  joeb
' Updated Comments
'
' Revision 1.37  2006/10/17 21:58:10  joeb
' FishingRate updates FishRateNo
'
' Revision 1.36  2006/10/02 20:10:38  joeb
' Removed incremental updating of shapes. Shapes must now be update explicitly.
'
' Revision 1.35  2006/09/30 14:22:12  joeb
' Changed updating of shapes to not call the shape manager on load
'
' Revision 1.34  2006/09/29 19:28:31  joeb
' Set call to update on Load
'
' Revision 1.33  2006/09/26 19:10:56  joeb
' Updating uses shape manager instead of the core
'
' Revision 1.32  2006/09/25 02:39:10  jeroens
' + Fixed database IDs in new shapes
' + Shapes now inform core state monitor of changes. This is ugly; should happen via managers
'
' Revision 1.31  2006/09/22 16:48:46  jeroens
' + Updated to use new fishing mort and rate forcing shapes
'
' Revision 1.30  2006/09/22 14:55:36  joeb
' Changed eShapeTypes to eDataTypes
'
' Revision 1.29  2006/09/21 19:55:21  joeb
' Changes to loading of the data and message sending
'
' Revision 1.28  2006/09/21 01:01:56  jeroens
' * Updated to ICoreInterface changes
' * Collection moved away from cForcingFuntion to cMediationFunction, where it belongs
'
' Revision 1.27  2006/09/19 18:40:16  joeb
' Data saving for Fishing Effort and Fish Mortality Managers
'
' Revision 1.26  2006/09/19 14:33:50  joeb
' Added Fishing Rate and Fish Mortality Shapes and Managers
'
' Revision 1.25  2006/09/15 02:36:48  jeroens
' + Strict on
'
'==============================================================================
