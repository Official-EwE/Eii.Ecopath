...
Namespace Ecosim
    ...
    Public Class gridQuotaOptions
        ...
        Protected Overrides Sub InitStyle()
            ...
            Me(0, eColumnTypes.MaxEffort) = New EwEColumnHeaderCell("Max Effort")
        ...
        Protected Overrides Sub FillData()
            ...
            For rowIndex As Integer = 1 To core.nFleets
                ...
                'Get the fleet info
                fleet = core.FleetInputs(rowIndex)

                ' Fleet name As row header
                Me(rowIndex, eColumnTypes.Index) = New EwERowHeaderCell(rowIndex)
                Me(rowIndex, eColumnTypes.Name) = New PropertyRowHeaderCell(fleet, eVarNameFlags.Name)

                ' Options cells
                Me(rowIndex, eColumnTypes.OptionNone) = New SourceGrid2.Cells.Real.CheckBox(True)
                Me(rowIndex, eColumnTypes.OptionWeakestStock) = New SourceGrid2.Cells.Real.CheckBox(True)
                Me(rowIndex, eColumnTypes.OptionStrongsetStockPlusDiscards) = New SourceGrid2.Cells.Real.CheckBox(True)
                Me(rowIndex, eColumnTypes.OptionAsumeSelectiveFishing) = New SourceGrid2.Cells.Real.CheckBox(True)
