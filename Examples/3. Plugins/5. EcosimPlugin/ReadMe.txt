The MonteCarloPlugin project demonstrates running Monte Carlo simulations
from within a plug-in. THe plug-in varies diets as a proof of concept, 
and produces results in the output window. There is no user interface.
