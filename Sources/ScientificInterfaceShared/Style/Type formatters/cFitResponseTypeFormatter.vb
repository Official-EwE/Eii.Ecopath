...
Namespace Style
    ...
    ''' ---------------------------------------------------------------------------
    ''' <summary>
    ''' Class for providing a textual description of <see cref="eFitResponseType"/>
    ''' </summary>
    ''' ---------------------------------------------------------------------------
    Public Class cFitResponseTypeFormatter
        ...
        Public Overloads Function ToString(ByVal value As Object, Optional ByVal descriptor As eDescriptorTypes = eDescriptorTypes.Name) As String _
            ...
            Try
                resp = DirectCast(value, eFitResponseType)
            Catch ex As Exception
                Return ""
            End Try

            Dim strVar As String = resp.ToString()
            Dim strDescr As String = cResourceUtils.LoadString("FITRESPONSE_" & strVar, My.Resources.ResourceManager)
