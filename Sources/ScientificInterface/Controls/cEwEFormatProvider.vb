...
' --== DELETED HISTORY ==--
'
' Revision 1.3  2008/06/19 08:45:00  jeroens
' Fixed crash
'
' Revision 1.2  2008/06/02 05:47:25  jeroens
' Renamed HIGHLIGHT style
'
' Revision 1.1  2008/06/02 00:01:19  jeroens
' Added ScientificInterfaceShared
'
' Revision 1.33  2008/05/29 22:23:00  jeroens
' Moved eVarNameFlags to EwEUtils
'
' Revision 1.32  2008/05/26 21:06:14  jeroens
' Combo boxes can provide string values as well
'
' Revision 1.31  2008/05/07 01:39:04  jeroens
' Fixed bugs 281, 378, 470
'
' Revision 1.30  2007/12/21 16:05:58  jeroens
' * PropertyFormatProvider offers refresh trigger
'
' Revision 1.29  2007/12/17 20:56:26  jeroens
' * Fixed propertyFP style retrieval bug
' * Checkbox bk color not affected on OK and NotEditable 'cause it looks downright silly
'
' Revision 1.28  2007/12/03 22:17:02  jeroens
' + Implemented Metadata for NumericUpDown controls
' * Fixed metatdata implementation bug for edit boxes
'
' Revision 1.27  2007/12/03 21:13:46  jeroens
' * Added alternate constructor
'
' Revision 1.26  2007/11/21 22:29:05  jeroens
' + Added q&d Enabled interface, which operates on Styles internally
'
' Revision 1.25  2007/10/30 18:41:04  jeroens
' + Added capabilty to use variable metadata
'
' Revision 1.24  2007/10/19 15:29:24  jeroens
' * Fixed bug 319
'
' Revision 1.23  2007/10/18 17:17:40  jeroens
' * Fixed bug 314
'
' Revision 1.22  2007/10/15 00:48:26  jeroens
' * FF display ID, ICoreInputOutput display Index on numbered labels
'
' Revision 1.21  2007/10/14 22:00:54  jeroens
' * Updated to styleguide changes
'
' Revision 1.20  2007/10/13 22:59:52  jeroens
' * Reused existing resources
'
' Revision 1.19  2007/10/10 19:32:08  jeroens
' * List of items can be set at any time
'
' Revision 1.18  2007/10/10 18:38:53  jeroens
' * Indexed items show both name and index
'
' Revision 1.17  2007/10/08 03:32:19  jeroens
' + Combo box FPs now accept a list of values (which can be ICoreInterface instances) to interact with a value/property
'
' Revision 1.16  2007/10/03 17:24:36  joeb
' Changed the setting of the value from Changed to LostFocus event
'
' Revision 1.15  2007/09/12 16:05:14  jeroens
' + Added label control support
'
' Revision 1.14  2007/08/09 00:45:10  jeroens
' + Implemented ComboBoxWrapper
'
' Revision 1.13  2007/08/03 16:28:30  jeroens
' * Uses StyleGuide change types
'
' Revision 1.12  2007/07/21 15:42:39  jeroens
' * Provided sets cProperty values w default notification scheme
'
' Revision 1.11  2007/07/03 03:25:33  jeroens
' * Fixed compiler warnings
'
' Revision 1.10  2007/06/15 14:04:09  jeroens
' * Style of a value considered when formatting numbers. Summed and   calculated values show with fixed precision.
'
' Revision 1.9  2007/06/12 15:26:06  jeroens
' * Update cb after Validated
'
' Revision 1.8  2007/06/11 12:39:51  jeroens
' * Checkbox background not coloured on style OK
'
' Revision 1.7  2007/06/07 03:51:45  jeroens
' + Added support for NumericUpDown controls, Check boxes
'
' Revision 1.6  2007/06/05 15:11:24  jeroens
' + Added support for highlighting managed controls
'
' Revision 1.5  2007/06/04 01:50:27  jeroens
' - Fixed compiler warnings
'
' Revision 1.4  2007/05/31 13:12:57  jeroens
' * Renamed StyleGuide StyleFlags to eStyleFlags
' + Uses StyleGuide FormatNumber
'
' Revision 1.3  2007/05/19 03:38:34  jeroens
' Strong-typed convert incoming values
'
' Revision 1.2  2007/04/11 17:19:29  jeroens
' + Fixed compiler bug
'
' Revision 1.1  2007/04/11 17:00:24  jeroens
' Initial version
'
'==============================================================================
...
#Region " Implementation "
            ...
            Public Sub UpdateContent() Implements IControlWrapper.UpdateContent
                ...
                Dim bNotEditable As Boolean = ((style And StyleGuide.eStyleFlags.NotEditable) = StyleGuide.eStyleFlags.NotEditable)
...
#Region " Implementation "
            ...
            Public Function Wrap(ByVal ctrl As System.Windows.Forms.Control, ByVal provider As cEwEFormatProvider, Optional ByVal aItems() As Object = Nothing, Optional ByVal metadata As EwECore.cVariableMetaData = Nothing) As Boolean _
                ...
                Try
                    ...
                    ' Apply metadata
                    If (metadata IsNot Nothing) Then
                        Me.m_ud.Minimum = CDec(metadata.Min)
                        Me.m_ud.Maximum = CDec(metadata.Max)
                    End If
                    ' Config control
...
#End Region ' Updates
    ...
    ''' </summary>
    ''' -----------------------------------------------------------------------
    Public Class PropertyFormatProvider
