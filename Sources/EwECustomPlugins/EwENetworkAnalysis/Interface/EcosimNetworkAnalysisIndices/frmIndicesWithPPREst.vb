'==============================================================================
'
' $Log: frmIndicesWithPPREst.vb,v $
' Revision 1.1  2008/09/26 07:30:52  sherman
' --== DELETED HISTORY ==--
'
' Revision 1.9  2008/06/18 21:48:15  joeh
' Compute and send Ecosim NA data to csv file - Take 2
'
' Revision 1.8  2008/06/18 20:16:03  joeh
' Plot Ascendency on flow in a second pane
'
' Revision 1.7  2008/06/14 03:47:25  joeh
...
'
' Revision 1.3  2007/06/20 18:13:59  joeh
...
Public Class frmIndicesWithPPREst
    Private Shared m_IndicesWithPPREstInstance As frmIndicesWithPPREst
    ...
    Private m_IndicesWithPPREst As cIndicesWithPPREst

    Public Shared Function GetInstance(ByVal NetworkManager As cNetworkManager, ByVal Panel As Windows.Forms.Panel) As frmIndicesWithPPREst
        m_Panel = Panel

        If m_IndicesWithPPREstInstance Is Nothing Then m_IndicesWithPPREstInstance = New frmIndicesWithPPREst(NetworkManager, Panel)
    ...
    Private Sub frmIndices_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        m_IndicesWithPPREst = cIndicesWithPPREst.GetInstance(m_NetworkManager, m_Panel)
        m_IndicesWithPPREst.CreatePlot(Me, ZedGraphControl)
        'Dim IndicesWithPPREst As cIndicesWithPPREst
        'IndicesWithPPREst = New cIndicesWithPPREst
        'IndicesWithPPREst.CreatePlot(m_NetworkManager, ZedGraphControl)
    End Sub
