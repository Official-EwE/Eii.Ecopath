...
Namespace My.Resources
    ...
    Public Class CoreMessages
        ...
        '''Computed Ecotrophic Efficiencies (EE) invalid for one or more groups..
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to QB &lt; PB for group &apos;{0}&apos;.
        '''</summary>
        Public Shared ReadOnly Property ECOPATH_INVALIDMODEL_PB_QB() As String
            Get
                Return ResourceManager.GetString("ECOPATH_INVALIDMODEL_PB_QB", resourceCulture)
            End Get
        End Property
        
        '''<summary>
        '''  Looks up a localized string similar to Your model is NOT mass-balanced!
        '''QB &lt; PB for one or more groups.
        '''</summary>
        Public Shared ReadOnly Property ECOPATH_INVALIDMODEL_PB_QB_GENERIC() As String
            Get
                Return ResourceManager.GetString("ECOPATH_INVALIDMODEL_PB_QB_GENERIC", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  Looks up a localized string similar to Respiration exceeds input to detritus for one or more groups..
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to Fixed escapement and fixed fishing mortalities have all been set for group(s) &apos;{0}&apos;; only the Fixed Escapement regulations will be used..
        '''</summary>
