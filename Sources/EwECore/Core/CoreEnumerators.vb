...
Public Enum eVarNameFlags As Integer
    ...
    ''' <summary>Ecospace Consumption by pred and prey averaged over all the cells in a region for each timestep.</summary>
    EcospaceRegionConsumption
    ''' <summary>Ecospace Landings by fleet and group averaged over all the cells in a region for each timestep.</summary>
    EcospaceRegionLandings
    ''' <summary>Ecospace Value by fleet and group averaged over all the cells in a region for each timestep.</summary>
    EcospaceRegionValue
    ''' <summary>Ecospace trophic level by group averaged over all the cells in a region for each timestep.</summary>
    EcospaceRegionTL
