...
Public Class cPlotOfMixedTrophicImpact
    ...
    Public Overrides Sub SaveToEMF(strFileName As String)
        ...
        Try
            ...
            msg = New cMessage(cStringUtils.Localize(SharedResources.GENERIC_FILESAVE_SUCCES, "MTI plot", strFileName),
                               eMessageType.DataExport, eCoreComponentType.External, eMessageImportance.Information)
            msg.Hyperlink = Path.GetDirectoryName(strFileName)
        Catch ex As Exception
            msg = New cMessage(cStringUtils.Localize(SharedResources.GENERIC_FILESAVE_FAILURE, strFileName),
