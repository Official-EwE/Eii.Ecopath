...
Namespace EwEAutoUpdateRef
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.3053"),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="UpdateServiceSoap", [Namespace]:="http://tempuri.org/")>  _
    Partial Public Class UpdateService
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/CheckPluginUpdate", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function CheckPluginUpdate(ByVal coreVer As String, ByVal pluginName As String, ByVal pluginToken As String, ByVal pluginVer As String) As Boolean
            Dim results() As Object = Me.Invoke("CheckPluginUpdate", New Object() {coreVer, pluginName, pluginToken, pluginVer})
            Return CType(results(0),Boolean)
        End Function
        
        '''<remarks/>
        Public Overloads Sub CheckPluginUpdateAsync(ByVal coreVer As String, ByVal pluginName As String, ByVal pluginToken As String, ByVal pluginVer As String)
            Me.CheckPluginUpdateAsync(coreVer, pluginName, pluginToken, pluginVer, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub CheckPluginUpdateAsync(ByVal coreVer As String, ByVal pluginName As String, ByVal pluginToken As String, ByVal pluginVer As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("CheckPluginUpdate", New Object() {coreVer, pluginName, pluginToken, pluginVer}, Me.CheckPluginUpdateOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/DownloadPlugin", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
