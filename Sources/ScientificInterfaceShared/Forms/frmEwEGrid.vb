...
#Region " Internal implementation "
            ...
            Private Function GetCSVFileName() As String
                Dim strFileName As String = Me.m_form.Core.EwEModel.Name & "-" & Me.m_form.Text
                If Not String.IsNullOrEmpty(Me.m_form.GetDataName()) Then
                    strFileName &= "_" & Me.m_form.GetDataName()
                End If
