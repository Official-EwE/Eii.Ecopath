...
Public Class LinkWrapper
    ...
    Public ReadOnly Property Style() As cStyleGuide.eStyleFlags
        Get
            ...
            For Each l As cLink In Me.m_lLinks
                ' ToDo: examine properties and concoct style here
                Dim st As cStyleGuide.eStyleFlags = cStyleGuide.eStyleFlags.OK
                If (l.ValuePerTon = 1.0) Then st = st Or cStyleGuide.eStyleFlags.ValueComputed
                ' Al.IsCOnfiogured also checks if source producer has a valid fleet attached
                If (Not l.IsConfigured) Then s = s Or cStyleGuide.eStyleFlags.MissingParameter
            Next
            Return s
        End Get
    End Property
