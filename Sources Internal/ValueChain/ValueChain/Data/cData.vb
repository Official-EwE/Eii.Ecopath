...
#Region " Database access "
    ...
    '''' </remarks>
    '''' -----------------------------------------------------------------------
    'Public Overridable Function Load(strModelName As String) As Boolean
    ...
    Private Sub OnElementChanged(element As cValueChainEntity)
        'Me.IsChanged |= element.IsChanged
    End Sub
...
#Region " Units "
    ...
    Public Function CreateUnit(unitType As cUnitFactory.eUnitType, strName As String) As cUnit
        ...
        If unit IsNot Nothing Then
            ...
            unit.Clone(Me.GetUnitDefault(unitType))
            ' Set default name
            unit.Name = strName
...
#Region " Metier management "
    ...
    Private Sub OnChanged(obj As cValueChainEntity)
...
#Region " Links "
    ...
    Public Function CreateLandingsLink(unitSource As cProducerUnit, unitTarget As cUnit, species As String, ByRef bError As Boolean, Optional bQuiet As Boolean = False) As cLinkLandings
        ...
        If unitSource.HasTarget(unitTarget, species) Then
            ' ToDo: log this
        ...
        link.Clone(Me.GetLinkDefault(cLinkFactory.GetLinkType(unitSource, unitTarget)))
    ...
    Public Sub OnGroupLinkChanged(unit As cValueChainEntity)
