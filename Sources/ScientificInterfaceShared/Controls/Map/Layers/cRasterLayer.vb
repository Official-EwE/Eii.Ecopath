...
#End If
            ...
            If (editor Is Nothing) Then editor = cRasterLayer.s_editorLocked
        ...
        ''' -----------------------------------------------------------------------
        Public Sub New(ByVal uic As cUIContext, ByVal layer As cRasterLayer)
