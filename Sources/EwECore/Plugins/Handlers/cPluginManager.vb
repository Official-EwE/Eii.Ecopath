...
Imports EwECore.Plugins.ContaminantTracing
    ...
    Public Function LoadPlugins(strSubfolder As String, bAllDirectories As Boolean, disabledPlugins As String()) As Integer
        ...
        Try
            ...
            For Each fi As FileInfo In afi
                ' skip the EwECore.dll itself. Of course.
                If fi.Name = "EwECore.dll" Then
                    Continue For
                End If
...
#Region " Ecospace "
    ...
    Public Function EcospaceResultsMapFleetFileName(ByRef FileName As String, varname As eVarNameFlags,
...
#Region " Plugin exception "
    ...
    Friend Sub RaisePluginException(assembly As cPluginAssembly, ex As Exception)
        ...
        Dim strAssembly As String = My.Resources.CoreDefaults.GENERIC_VALUE_UNKNOWN

        If (assembly IsNot Nothing) Then
            strAssembly = assembly.AssemblyName.Name
        End If

        Me.RaisePluginException(New cPluginException(assembly, String.Format(My.Resources.CoreDefaults.PLUGIN_ERROR_GENERIC, strAssembly, ex.Message), ex))
    ...
    Friend Sub RaisePluginException(assembly As cPluginAssembly, plugin As IPlugin,
      strMethodName As String, ex As Exception)
        ...
        Dim strAssembly As String = My.Resources.CoreDefaults.GENERIC_VALUE_UNKNOWN
        Dim strPlugin As String = My.Resources.CoreDefaults.GENERIC_VALUE_UNKNOWN
        ...
        Me.RaisePluginException(New cPluginException(assembly, String.Format(My.Resources.CoreDefaults.PLUGIN_ERROR_POINT, strAssembly, strPlugin, strMethodName, ex.Message), ex))
