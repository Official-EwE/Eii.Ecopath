The BasePlug project demonstrates the basic integration features of plug-ins with
the EwE6 foundation: model loading, saving and unloading; scenario loading and
unloading; and (sub) model execution.
