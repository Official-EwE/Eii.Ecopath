...
''' ---------------------------------------------------------------------------
''' <summary>
''' Buffer class for interfacing with a FishBase ODBC database.
''' </summary>
''' ---------------------------------------------------------------------------
Public Class cFishBaseOdbcConnection
...
#End Region ' Construction / destruction
    ...
    ''' <returns></returns>
    ''' -----------------------------------------------------------------------
    Public Shadows Function Connect(strConn As String, strUser As String, strPwd As String) As Boolean
        If Me.IsConnected Then Me.Disconnect()
        Dim str As String = String.Format("DSN={0};UID={1};PWD={2};", strConn, strUser, strPwd)
    ...
    Public Overrides Function Search(ByVal taxon As ITaxonSearchData, iMaxResults As Integer) As Boolean
        ...
        Dim bSearchComm As Boolean = True ' ((taxon.SearchFields And eTaxonLevelType.Common) > 0)
