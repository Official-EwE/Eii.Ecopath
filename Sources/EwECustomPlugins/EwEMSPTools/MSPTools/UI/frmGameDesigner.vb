...
#Region " Overrides "
        ...
        Protected Overrides Sub OnLoad(e As EventArgs)
            ...
            Me.m_qeh.Attach(Me.m_gridOutcome, Me.UIContext, Me.m_tsOutcome, Me.m_gridOutcome.SuppressQuickEdits)
...
#Region " Credits "
        ...
        ''' <param name="e">Ignored</param>
        ''' -----------------------------------------------------------------------
        Private Sub OnVisitNHTV(sender As Object, e As EventArgs) Handles m_pbBUAS.Click
            Me.Visit("https://www.nhtv.nl/")
        End Sub
        ...
        ''' <param name="e">Ignored</param>
        ''' -----------------------------------------------------------------------
        Private Sub OnVisitMSPChallenge(sender As Object, e As EventArgs) Handles m_pbMSPC.Click
            Me.Visit("httsp://www.mspchallenge.info/")
        End Sub
        ...
        Private Sub OnEcospaceTimeStep(ByRef data As cEcospaceTimestep)
            ...
            If (Me.m_cbEmulPauseSpace.Checked) Then
                ...
                Select Case Me.m_cmbEmulPauseOptions.SelectedIndex
                    Case 0 : bPause = True
                    Case 1 : bPause = CInt(data.iTimeStep Mod parms.NumberOfTimeStepsPerYear) = 0
                    Case 2 : bPause = CInt(data.iTimeStep Mod (5 * parms.NumberOfTimeStepsPerYear)) = 0
                End Select
                If (bPause = True) Then
