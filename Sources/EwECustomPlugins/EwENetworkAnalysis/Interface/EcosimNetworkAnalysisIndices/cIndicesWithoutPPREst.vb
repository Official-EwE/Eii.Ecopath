...
'
' Revision 1.10  2008/06/18 20:16:02  joeh
' Plot Ascendency on flow in a second pane
'
' Revision 1.9  2008/06/14 00:00:28  joeh
' Compute and send ecosim NA data to csv file
'
' Revision 1.8  2007/07/06 00:44:59  joeh
' Move hard coded strings to resource file
'
' Revision 1.7  2007/07/05 23:48:13  joeh
' Move hard coded strings to resource file
'
...
Public Class cIndicesWithoutPPREst
    ...
    Private Shared m_IndicesWithoutPPREstInstance As cIndicesWithoutPPREst

    Private m_NetworkManager As cNetworkManager
    Private Shared m_Panel As Panel

    Public Shared Function GetInstance(ByVal NetworkManager As cNetworkManager, ByVal Panel As Windows.Forms.Panel) As cIndicesWithoutPPREst
        m_Panel = Panel

        If m_IndicesWithoutPPREstInstance Is Nothing Then m_IndicesWithoutPPREstInstance = New cIndicesWithoutPPREst(NetworkManager, Panel)
    ...
    Public Sub CreatePlot(ByVal Frm As Form) ', ByVal Zgc As ZedGraphControl)
        ...
        'Pane2
        pane = zgh.ConfigurePane("", My.Resources.LBL_TIME_STEP, My.Resources.LBL_NA_INDIC, True, LegendPos.TopCenter, 2)
        'Add curves
        pane.CurveList.Clear()
        'Ascendency on flow
