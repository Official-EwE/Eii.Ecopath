      ...
      ByVal Algor As String)
        Select Case Algor
            ...
            Case My.Resources.TREE_NODE_OMNI_IDX, My.Resources.TREE_NODE_USER_DEF_SIGMA
                DataGrid.RowCount = EcotrophManager.Flow.GetUpperBound(0) + 1
        End Select
    ...
    Private Shared Sub SetUpGridColumn(ByVal DataGrid As DataGridView, ByVal EcotrophManager As cEcotrophManager, _
      ByVal Algor As String)
        ...
        Select Case Algor
            ...
            Case My.Resources.TREE_NODE_OMNI_IDX, My.Resources.TREE_NODE_USER_DEF_SIGMA
                DataGrid.Columns(1).HeaderText = My.Resources.COL_HDR_GRP_NAMEPB
        End Select
      ...
      ByVal Algor As String)
        ...
        Select Case Algor
            ...
            Case My.Resources.TREE_NODE_USER_DEF_SIGMA
                ...
                Next
                'DataGrid.CurrentCell = DataGrid.Item(0, 0)
    ...
    Private Shared Sub SetUpAryRow(ByVal DataGrid As DataGridView, ByVal EcotrophManager As cEcotrophManager, _
      ByVal Algor As String)
        ...
        For Row As Integer = 1 To EcotrophManager.Flow.GetUpperBound(0)
            ...
            End If
            For Col As Integer = 1 To EcotrophManager.Flow.GetUpperBound(1)
                If Single.IsNaN(EcotrophManager.Flow(Row, Col)) Then
                    RowContent(Col + 1) = ""
                Else
