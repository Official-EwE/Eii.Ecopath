...
Module modUtility
    ...
    Public Function CRoman(ByVal intArabic As Integer) As String
    ...
    Public Sub InitializePane(ByVal Pane As GraphPane, ByVal XAxisTitle As String, ByVal YAxisTitle As String)
        Pane.Title.Text = ""
        Pane.XAxis.Title.Text = XAxisTitle
        Pane.XAxis.Title.FontSpec.Size = 17
        Pane.XAxis.MajorTic.IsOutside = False
        Pane.XAxis.MinorTic.IsOutside = False
        Pane.YAxis.Title.Text = YAxisTitle
        Pane.YAxis.Title.FontSpec.Size = 17
    ...
    Public Sub AddCurve(ByVal CurveName As String, ByVal CurveVar() As Single, ByVal Pane As GraphPane, _
      ByVal MyColor As Color, Optional ByVal Symbol As SymbolType = SymbolType.None)
        ...
        For iTime As Integer = 1 To CurveVar.GetUpperBound(0)
            List.Add(iTime, CurveVar(iTime))
        Next
        Curve = Pane.AddCurve(CurveName, List, MyColor, Symbol)
    End Sub
