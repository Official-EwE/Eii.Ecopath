...
Namespace SpatialData
    ...
    Public Class cAAASFileDataSetPlugin
...
#Region " Overrides "
        ...
        Protected Overrides Function LoadSource() As Boolean
            ...
            If (System.IO.File.Exists(strFileName)) Then
                ...
                Me.LogMessage("Loaded " & Me.m_raster.ToString & " from " & strFileName, eStatusFlags.OK)
            Else
                Me.LogMessage("Failed to find raster " & strFileName, eStatusFlags.ErrorEncountered)
            End If
...
#Region " Plug-in implementation "
        ...
        Public Overrides ReadOnly Property PluginDescription As String
            Get
                Return "Plug-in that provides direct access to a series of half-degree, global ASCII files prepared for AAAS"
            End Get
        End Property
