'==============================================================================
'
' $Log: cF2TSResults.vb,v $
' Revision 1.1  2008/09/26 07:30:24  sherman
' --== DELETED HISTORY ==--
'
' Revision 1.18  2008/02/01 16:53:15  joeb
' Bunch of stuff for Multi threading
'
' Revision 1.17  2008/01/26 00:17:35  joeb
' Move binning of sensitivity to manager/model
'
' Revision 1.16  2007/11/29 18:42:18  joeb
' Moved BaseSS to base class
'
' Revision 1.15  2007/10/23 19:25:04  joeb
' Added SensitivitySS2VByPredator
'
' Revision 1.14  2007/10/22 23:02:50  joeb
' RunSensitivitySS2VByPredPrey
'
' Revision 1.13  2007/09/26 18:29:19  joeb
' Added FitToTimeSeries Namespace
'
' Revision 1.12  2007/09/25 23:24:52  joeb
' Adding interaction with the model
'
' Revision 1.11  2007/09/10 19:22:43  joeh
' Modify search iteration data for testing F2TS GUI
'
' Revision 1.10  2007/09/08 01:21:48  joeh
' Change data for testing Search analysis
'
' Revision 1.9  2007/09/07 21:44:39  joeh
' Add data and property for the Search result
'
' Revision 1.8  2007/09/07 18:34:56  jeroens
' * Added support for cloning all known result types
'
' Revision 1.7  2007/09/05 18:07:39  joeh
' Rename some variables
' Add properties for the Sensitivity By Pred Column analysis
'
' Revision 1.6  2007/09/05 01:01:13  joeh
' Partial implementation of "Sensitivity by predator column" button
'
' Revision 1.5  2007/09/01 01:19:37  jeroens
' * Has three result classes
' + Base result class holds iStep, nSteps
'
' Revision 1.4  2007/08/29 22:30:02  joeh
' Modify codes for testing the retrieval of sensitivity result data
'
' Revision 1.3  2007/08/29 00:11:09  joeh
' Add dummy data for sensitivity results
'
' Revision 1.2  2007/08/25 15:01:54  jeroens
' * Morphing, morphing
'
' Revision 1.1  2007/08/24 19:19:56  jeroens
' Initial version
'
' Revision 1.1  2007/08/23 14:51:56  jeroens
' Initial version
'
'==============================================================================
