...
#Region " Constructor "
    ...
    Public Sub New(uic As cUIContext, data As cData, controller As cValueChainController, result As cResults)
...
#Region " Events "
    ...
    Protected Overrides Sub OnLoad(e As System.EventArgs)
        ...
        Select Case Me.m_controller.RunType
            Case eRunTypes.Ecopath : Me.SetViewMode(eViewModeType.Grid)
            Case eRunTypes.Ecosim : Me.SetViewMode(eViewModeType.Graph)
            Case eRunTypes.Equilibrium : Me.SetViewMode(eViewModeType.GraphEquilibrium)
        End Select
    ...
    Private Sub OnSaveResults(sender As System.Object, e As System.EventArgs) _
        ...
        Try
            Me.m_controller.SaveResults(Me.m_data, Me.m_result)
...
#Region " Commands "
    ...
    Private Sub OnInvokeRunEcopath(cmd As cCommand)
        ...
        Me.m_controller.IsManualRunMode = True
        Me.m_data.Parameters.RunWithEcopath = True

        cApplicationStatusNotifier.StartProgress(core, My.Resources.STATUS_RUNNING_ECOPATH)
        ...
        Try
            ...
            Me.m_result.Reset(core.nFleets, core.nGroups, 1)
        ...
        Me.m_controller.IsManualRunMode = False
    ...
    Private Sub OnInvokeRunEcosim(cmd As cCommand)
        ...
        cApplicationStatusNotifier.StartProgress(core, My.Resources.STATUS_RUNNING_ECOSIM)
        ...
        Try
            ...
            '    In manual mode the calling process becomes responsible for resetting results
            Me.m_result.Reset(core.nFleets, core.nGroups, core.nEcosimTimeSteps)
            ' Prepare view
            Me.SetViewMode(eViewModeType.Graph)
    ...
    Private Sub OnInvokeRunEquilibrium(cmd As cCommand)
        ...
        Dim core As cCore = Me.m_uic.Core
        cApplicationStatusNotifier.StartProgress(core, My.Resources.STATUS_RUNNING_EQUILIBRIUM)
        ...
        Try
            ...
            Me.SetViewMode(eViewModeType.GraphEquilibrium)
            ' Run
            Me.m_controller.RunEquilibrium(Me.m_data, Me.m_result)
        Catch ex As Exception
