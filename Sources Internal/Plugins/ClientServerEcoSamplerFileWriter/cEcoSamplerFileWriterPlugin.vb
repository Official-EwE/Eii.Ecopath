...
''' </remarks>
''' 
Public Class cEcoSamplerFileWriterPlugin
...
#Region " Local variables"
    ...
    Private m_form As frmEwEEcoSamplerFileWriterForm = Nothing

    Private m_FileWriter As cEcoSamplerFileWriter
...
#Region "Ecopath, Ecosim and Ecospace events"
    ...
    Public Sub Initialize(CoreAsObject As Object) Implements EwEPlugin.IPlugin.Initialize
        Try
            ...
            Me.m_FileWriter = New cEcoSamplerFileWriter(Me)
    ...
    Public Function LoadModel(dataSource As Object) As Boolean Implements EwEPlugin.IEcopathPlugin.LoadModel
        Try
            ...
            Me.FileWriter.DefautlFilename = ModelDataBase.FileName + "_MonteCarlo_Sample_Data.csv"
    ...
    Public Sub OnControlClick(ByVal sender As Object, ByVal e As System.EventArgs, ByRef form As System.Windows.Forms.Form) Implements EwEPlugin.IGUIPlugin.OnControlClick
        ...
        If m_uic IsNot Nothing Then
            ...
            If Not bHasInterface Then
                ...
                Me.m_form = New frmEwEEcoSamplerFileWriterForm()
                Me.m_form.Init(Me)
...
#Region "IPlugin implementation"
    ...
    Public ReadOnly Property Contact As String Implements EwEPlugin.IPlugin.Contact
        Get
            Return "joe@mountainsoft.net"
        End Get
    End Property

    Public ReadOnly Property Description As String Implements EwEPlugin.IPlugin.Description
        Get
            Return "Write EcoSampler records to file"
        End Get
    End Property

    Public ReadOnly Property Name As String Implements EwEPlugin.IPlugin.Name
        Get
            Return "EwEEcoSamplerFileWriter"
        End Get
    End Property
