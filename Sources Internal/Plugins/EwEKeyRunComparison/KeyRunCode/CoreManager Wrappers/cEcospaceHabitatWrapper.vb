...
Public Class cEcospaceHabitatWrapper
    ...
    Public Overrides Function HashValues() As System.Collections.Generic.List(Of cHashValues)
        'Debug.Assert(False, "cEcospaceHabitatWrapper  habitat area prop doesn't seem to be working!!!! Really something is messed up.")
