...
Namespace Ecosim
    ...
    ''' </summary>
    ''' -----------------------------------------------------------------------
    Public Class dlgDefineBioPercent
...
#Region " Event handlers "
        ...
        ''' </summary>
        ''' -------------------------------------------------------------------
        Private Sub m_lbAvailableGroupsFleets_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles m_lbAvailableGroupsFleets.SelectedIndexChanged
            Me.UpdateControls()
        End Sub
