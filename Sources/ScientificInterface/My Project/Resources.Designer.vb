...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Looks up a localized string similar to Overlay {0}.
        '''</summary>
        Friend ReadOnly Property ECOSIM_LABEL_OVERLAY() As String
            Get
                Return ResourceManager.GetString("ECOSIM_LABEL_OVERLAY", resourceCulture)
            End Get
        End Property
