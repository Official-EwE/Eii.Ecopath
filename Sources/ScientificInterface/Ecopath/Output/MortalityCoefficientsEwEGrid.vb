...
Namespace Ecopath.Output
    ...
    Public Class MortalityCoefficientsEwEGrid
        ...
        Protected Overrides Sub InitStyle()
            ...
            Me(0, eColumnTypes.PredMort) = New EwEColumnHeaderCell(SharedResources.HEADER_PREDMORTRATE_UNIT, cStyleGuide.eUnitType.Time)
            Me(0, eColumnTypes.BioAccum) = New EwEColumnHeaderCell(SharedResources.HEADER_BIOMACCURATE_UNIT, cStyleGuide.eUnitType.Time)
            Me(0, eColumnTypes.NetMig) = New EwEColumnHeaderCell(SharedResources.HEADER_NETMIGRATE_UNIT, cStyleGuide.eUnitType.Time)
            Me(0, eColumnTypes.OtherMort) = New EwEColumnHeaderCell(SharedResources.HEADER_OTHERMORTRATE_UNIT, cStyleGuide.eUnitType.Time)
