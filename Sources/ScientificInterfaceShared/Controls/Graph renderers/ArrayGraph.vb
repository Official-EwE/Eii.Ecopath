...
Public Class ArrayGraph
    ...
    ''' <param name="strLegendX">Legend to render along the X axis.</param>
    ''' <param name="astrLabelsX">Labels to render along the X axis.</param>
    ''' <param name="strLegendY">Legend to render along the Y axis.</param>
    ...
    Public Sub Draw(ByVal g As Graphics, ByVal rcRender As Rectangle, _
                    ByVal asData As Single(,), ByVal strLegendX As String, ByVal astrLabelsX As String(), _
                    Optional ByVal strLegendY As String = Nothing, Optional ByVal astrLabelsY As String() = Nothing)
        ...
        Dim szLegendTop As Size = Me.CalcLegendMaxSize(g, strLegendX)
        Dim szLegendSide As Size = Me.CalcLegendMaxSize(g, strLegendY)
        ...
        ' Top text
        DrawLabelsTop(g, rcArea1, sCellSize, strLegendX, astrLabelsX, szLabelTopMaxSize, -90 + cLABEL_TOPAXIS_ANGLE)
        ' Side text
        DrawLabelsSide(g, rcArea3, sCellSize, strLegendY, astrLabelsY)
        ' Graph
