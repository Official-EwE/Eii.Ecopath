...
#Region " Form overrides "
    ...
    Protected Overrides Sub UpdateControls()
        ...
        Dim bHasVars As Boolean = (Me.m_clbVars.CheckedItems.Count > 0)
...
#Region " Event handlers "
    ...
    Private Sub OnItemChecking(sender As Object, e As System.Windows.Forms.ItemCheckEventArgs) _
        Handles m_clbVars.ItemCheck, m_clbFilesSrc.ItemCheck
    ...
    Private Sub OnRun(sender As System.Object, e As System.EventArgs) _
        ...
        Try
            ...
            For Each item As Object In Me.m_clbVars.CheckedItems
                lOptions.Add(DirectCast(item, cEcosimResultWriter.eResultTypes))
            Next

            Dim engine As New cPerturbFFEngine(Me.UIContext, lFiles.ToArray(), Me.m_tbxDest.Text, Me.m_rbMonthly.Checked, lOptions.ToArray())
            engine.Run()
